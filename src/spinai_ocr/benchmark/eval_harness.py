...
Typical usage in CI::
    ...
    from spinai_ocr.benchmark.eval_harness import RegressionGate, eval_recognizer
...
from spinai_ocr.benchmark.metrics import _levenshtein_seq, compute_cer, compute_wer
from spinai_ocr.io import save_json
from spinai_ocr.log import get_logger, log_span
from spinai_ocr.models.recognition import build_recognition
from spinai_ocr.training.datamodule import RecognitionTrainingDataset, recognition_collate
from spinai_ocr.vocab.base import Vocab, load_vocab

log = get_logger("spinai_ocr.benchmark.eval")
...
def eval_recognizer(
    ...
    *,
    ...
    if "vocab_chars" in ckpt:
        from spinai_ocr.vocab.base import JamoVocab
