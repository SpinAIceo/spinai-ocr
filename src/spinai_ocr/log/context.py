...
def capture_crashes(tag: str, extra: dict | None = None, reraise: bool = True, logger_name: str | None = None):
    ...
    """
    lg = logging.getLogger(logger_name or f"spinai_ocr.capture.{tag}")
...
def log_span(name: str, logger_name: str | None = None, level: int = logging.INFO, **extra):
    ...
    lg = logging.getLogger(logger_name or "spinai_ocr.span")
...
class StepLogger:
    ...
    def __post_init__(self) -> None:
        self._logger = logging.getLogger(f"spinai_ocr.step.{self.name}")
