...
Usage:
    from spinaiocr.log import get_logger, setup_logging, capture_crashes
...
from spinaiocr.log.config import LogConfig, setup_logging
from spinaiocr.log.context import capture_crashes, log_span, StepLogger
from spinaiocr.log.guards import (
    NaNInfGuard,
    check_finite,
    format_tensor_brief,
    oom_hint,
