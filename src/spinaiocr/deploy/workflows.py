...
from spinaiocr.io.logged_io import sha256_of_file
from spinaiocr.log import capture_crashes, get_logger, log_span

log = get_logger("spinaiocr.deploy")
    ...
    *,
    ...
    with capture_crashes("onnx.export",
        ...
        with log_span("onnx.export", task=task, out=str(out_path)):
            cmd = [
                "python", "-m", "spinaiocr.deploy.onnx_export",
