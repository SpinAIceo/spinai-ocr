...
Run one iteration:
    ...
    python -m spinaiocr.training.continuous \
...
from spinaiocr.data.adapters import CropSpec, jsonl_to_recognition_tsv
from spinaiocr.data.mining import MiningConfig, mine_directory, partition_by_priority
from spinaiocr.data.pseudo import ConsensusConfig
from spinaiocr.inference.pipeline import OCRPipeline
from spinaiocr.teachers.base import build_teacher
