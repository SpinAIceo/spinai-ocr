...
def test_jamo_correct_import():
    from spinaiocr.postprocess.jamo_correct import correct_jamo  # noqa: F401
...
def test_angle_classifier_import():
    from spinaiocr.models.angle_cls import AngleClassifier  # noqa: F401
...
def test_angle_classifier_rotate_noop():
    ...
    import numpy as np
    from spinaiocr.models.angle_cls import rotate_to_upright
...
def test_recognition_config_flags():
    from spinaiocr.config import RecognitionConfig
...
def test_pipeline_import():
    ...
    from spinaiocr.inference.pipeline import OCRPipeline  # noqa: F401
